    ...
    return (
        <>
            ...
            <div className="w-full h-screen bg-cover bg-center flex flex-col justify-center font-inter items-center bg-no-repeat bg-homebg">
                ...
                <Link to={'/menu'} data-aos="fade-in" data-aos-once="true" data-aos-delay="2000" className='flex justify-center items-center hover:brightness-75 transition-all duration-300 ease-in-out absolute bottom-20 text-white'>
