...
const Header = (props) => {
    ...
    return (
        <>
            <header data-aos={(animation)} data-aos-once={(once)} data-aos-delay={(delay)} className={`z-10 fixed w-full h-20 flex laptop:justify-center tablet:justify-end tablet:pr-16 items-center ${blur > 10 ? 'backdrop-blur-sm transition-all duration-500' : 'bg-opacity-0'}`}>
