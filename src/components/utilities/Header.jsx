...
const Header = (props) => {
    ...
    return (
        <>
            <header data-aos={(animation)} data-aos-once="true" data-aos-delay={(delay)} className={`z-10 fixed w-full h-20 flex justify-center items-center ${blur > 0 ? 'backdrop-blur-sm transition-all duration-500' : 'bg-opacity-0'}`}>
